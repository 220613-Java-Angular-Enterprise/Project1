...
>***:clock2: Due Friday July 15th, 2022***
...
1. File-based or programmatic configuration of entities
...
It is encouraged that you provide clear documentation on how to use your framework in the form of a `README.md` file, example 
...
## Presentation
- [ ] Finalized version of framework must be pushed to your team repository by the presentation date (July 15th, 2022)
...
- [ ] *You will be presenting **July 15th, 2022***
